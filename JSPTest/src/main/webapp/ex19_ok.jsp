...
<%
	...
	/* 
		...
		cos.jar > MultipartRequest 클래스를 request를 대신 한다.
	...
	*/
	...
	//String path="C:\\class\\code\\server\\JSPTest\\src\\main\\webapp";
	
	String path = application.getRealPath("/files");
	//C:\class\code\server\.metadata\.plugins\org.eclipse.wst.server.core\tmp1\wtpwebapps\JSPTest\files
	...
	try { 
		...
		MultipartRequest multi = new MultipartRequest(
									...
									size, 	// 최대 크기
									"UTF-8", //인코딩
									new DefaultFileRenamePolicy() //파일명 관리 및 넘버링
								);
		//일반 데이터 수신
