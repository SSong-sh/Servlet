...
<style>
	#tbl1 td:nth-child(1) { width : 30px; text-align : center; font-size : 0;}
...
<body class="narrow">
	...
	<table id="tbl1">
		...
		<tr>
			...
			<td class="checked"> ${dto.checked}${dto.todo}<span>${dto.regdate}</span></td>
		</tr>
		</c:forEach>
	...
	<script>
		...
		$('#tbl1 tr').click(()=> {
			...
			//tr 찾기 -> alert(event.currentTarget.nodeName);
