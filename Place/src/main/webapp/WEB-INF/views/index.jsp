...
<style>
	...
	#tblView tr:nth-chide(1) th:nth-child(1) {width: 150px;}
	#tblView tr:nth-chide(1) td:nth-child(2) {width: 300px;}
	#tblView tr:nth-chide(1) th:nth-child(3) {width: 150px;}
	#tblView tr:nth-chide(1) td:nth-child(4) {width: auto;}
...
<body class="wide">
	...
	<div id="main">
		...
		<table id="tblView">
			<tr>
				<th>장소명</th>
				<td id=viewName>000</td>
				<th>좌표</th>
				<td>(<span id=viewLat></span>000,000<span id="viewLng"></span>)</td>
			</tr>
			<tr>
				<th>주소</th>
				<td colspan="3" id="viewAddress">000</td>
			</tr>
			<tr>
				<th>설명</th>
				<td colspan="3" id="viewDescription">000</td>
			</tr>
		</table>
	</div>
	...
	<div data-sidebar-window="add" data-sidebar-title="Add Place" data-sidebar-direction="left" data-sidebar-size="wide">
		...
		<table id="tblAdd">
			...
			<tr>
				<td><textarea name="description" id" placeholder="장소에 대한 설명을 입력하세요."></textarea></td>
			</tr>
		</table>
		<div>
	...
	const options2 = { //지도를 생성할 때 필요한 기본 옵션
		center: new kakao.maps.LatLng( 37.49930942404527,127.03331872237), //지도의 중심좌표.
		level: 3 //지도의 레벨(확대, 축소 정도)
	};
	...
	function selPlace(seq) {
		...
		plist.forEach(obj => {
			...
			if(obj.seq == seq) {
				...
				$('#viewLat').text(obj.lat.substr(0,7));
				$('#viewLng').text(obj.lng.substr(0,7));
